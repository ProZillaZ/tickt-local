...
export class RecipeRepository extends BaseRepository<RecipeDocument> {
	 ...
	 */
	async findWithAdvancedFilters(query: RecipeQueryDto): Promise<PaginatedResponse<RecipeDocument>> {
	 ...
	 */
	async findByCuisine(cuisine: Cuisine, options?: QueryOptions): Promise<RecipeDocument[]> {
	 ...
	 */
	async findByMealType(mealType: MealType, options?: QueryOptions): Promise<RecipeDocument[]> {
	 ...
	 */
	async findByDietType(dietType: DietType, options?: QueryOptions): Promise<RecipeDocument[]> {
	 ...
	 */
	async findByDifficulty(difficulty: Difficulty, options?: QueryOptions): Promise<RecipeDocument[]> {
	 ...
	 */
	async searchByIngredient(ingredient: string, options?: QueryOptions): Promise<RecipeDocument[]> {
		const filter = { 'ingredients.name': { $regex: ingredient, $options: 'i' } };
	 ...
	 */
	async searchByTag(tag: string, options?: QueryOptions): Promise<RecipeDocument[]> {
	 ...
	 */
	async findByCreator(createdBy: string, options?: QueryOptions): Promise<RecipeDocument[]> {
	 ...
	 */
	async searchByText(searchText: string, options?: QueryOptions): Promise<RecipeDocument[]> {
	 ...
	 */
	private buildAdvancedFilter(query: RecipeQueryDto): FilterQuery<RecipeDocument> {
		const filter: FilterQuery<RecipeDocument> = {};
