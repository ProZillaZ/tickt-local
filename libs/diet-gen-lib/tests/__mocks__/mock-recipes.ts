...
export const mockBreakfastRecipe: Recipe = new Recipe(
    ...
    [
        ...
        new Instruction(3, 'Pour eggs into pan and gently scramble for 2-3 minutes'),
    ...
    Difficulty.EASY,
    new NutritionalInfo(420, 24, 28, 22, 4),  // calories, protein, carbs, fat, fiber
...
export const mockLunchRecipe: Recipe = new Recipe(
    ...
    [
        ...
        new Instruction(2, 'Grill chicken for 6-7 minutes on each side until cooked through'),
    ...
    Difficulty.EASY,
    new NutritionalInfo(380, 45, 12, 18, 8),  // calories, protein, carbs, fat, fiber
...
export const mockDinnerRecipe: Recipe = new Recipe(
    ...
    Difficulty.MEDIUM,
    new NutritionalInfo(620, 48, 45, 28, 12), // calories, protein, carbs, fat, fiber
...
export const mockVegetarianRecipe: Recipe = new Recipe(
    ...
    [new Tag('vegetarian'), new Tag('vegan'), new Tag('spicy'), new Tag('protein-rich')],
    Difficulty.MEDIUM,
    new NutritionalInfo(540, 22, 48, 28, 16), // calories, protein, carbs, fat, fiber
...
export const mockSnackRecipe: Recipe = new Recipe(
    ...
    Difficulty.EASY,
    new NutritionalInfo(280, 18, 32, 12, 8), // calories, protein, carbs, fat, fiber
...
export const mockBreakfastRecipes: Recipe[] = [
    ...
    new Recipe(
        ...
        Difficulty.EASY,
        new NutritionalInfo(350, 15, 58, 8, 12),
...
export const mockLunchRecipes: Recipe[] = [
    ...
    new Recipe(
        ...
        [new Tag('quick'), new Tag('protein-rich')],
        Difficulty.EASY,
        new NutritionalInfo(450, 35, 35, 18, 10),
...
export const mockDinnerRecipes: Recipe[] = [
    ...
    new Recipe(
        ...
        Difficulty.MEDIUM,
        new NutritionalInfo(580, 42, 48, 22, 8),
...
export const mockSnackRecipes: Recipe[] = [
    ...
    new Recipe(
        ...
        Difficulty.EASY,
        new NutritionalInfo(220, 8, 28, 12, 6),
