...
const Slide3: React.FC<SlideComponentProps> = ({ handleNext, updateStepData, onboardingState }) => {
	const {
		state,
		setState,
		allergies,
	...
	const handleFreeDaysChange = useCallback((data: string[]) => {
	...
	return (
		<View style={styles.container}>
			<ScrollView>
				<Content headerText="almost there..."
